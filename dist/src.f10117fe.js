...
function (_super) {
  ...
  function UserList() {
    ...
    _this.renderItem = function (model, itemParent) {
...
function () {
  function Model(attributes, events, sync) {
    ...
    this.save = function () {
      _this.sync.save(_this.attributes.getAll()).then(function () {
        _this.trigger('save');
      })["catch"](function () {
...
function () {
  function Attributes(data) {
    ...
    this.set = function (update) {
      _this.data = __assign({}, _this.data, update);
    };
...
function () {
  function ApiSync(rootUrl) {
    ...
    this.save = function (data) {
      var id = data.id;
      return id ? axios_1["default"].put(_this.rootUrl + "/" + id, data) : axios_1["default"].post(_this.rootUrl, data);
    };
  }
